...
import { INVESTOR_DETAILS, VESTING_CLIFF, VESTING_END, VESTING_START } from "@deployments/constants/015_index_sale";
...
describe("OtcEscrow", () => {
  ...
  before(async () => {
    ...
    const deployedOtcEscrow = await getContractAddress("OtcEscrow - " + INVESTOR_DETAILS[0].address);
